...
if(IntVal($userGroupID) > 0)
{
	...
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/actions/"), Array($userGroupID => "W"));
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/include/"), Array($userGroupID => "W"));
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/map/"), Array($userGroupID => "W"));
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/portfolio/"), Array($userGroupID => "W"));
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/price/"), Array($userGroupID => "W"));
	...
	WizardServices::SetFilePermission(Array($siteID, $SiteDir . "/video/"), Array($userGroupID => "W"));*/
}
?>